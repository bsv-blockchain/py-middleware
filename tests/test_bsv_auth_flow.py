...
class BSVAuthFlowTester:
    ...
    def test_nonce_functionality(self) -> Dict[str, Any]:
        ...
        try:
            ...
            create_tests = [
                ...
                {'test': 'create_nonce_without_wallet', 'nonce': nonce3, 'success': len(nonce3) >= 16}
            ]
    ...
    def run_all_auth_tests(self) -> Dict[str, Any]:
        ...
        print(f"🎲 Nonce Tests: Create {create_passed}/{create_total}, Verify {verify_passed}/{verify_total}")
