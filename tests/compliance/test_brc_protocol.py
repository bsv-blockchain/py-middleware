...
class BRCProtocolTester:
    ...
    def test_brc_103_headers(self):
        ...
        for header in required_headers:
            ...
            detected = any(key.lower().replace('_', '-') == header for key in request.META.keys() if key.startswith('HTTP_'))
    ...
    def test_response_format_compliance(self):
        ...
        for scenario in test_scenarios:
            ...
            try:
                ...
                missing_fields = [
                    field for field in scenario['expected_fields']
    ...
    def test_error_response_compliance(self):
        ...
        for scenario in error_scenarios:
            ...
            try:
                ...
                if not missing_fields:
                    print(f"      ✅ All error fields present")
                else:
