...
class ExpressCompatibilityTester:
        ...
        for test in express_compatibility_tests:
            ...
            try:
                ...
                if not missing_fields and all(match for _, match in type_matches):
                    print(f"      ✅ 100% Express compatible")
                    self.compatibility_score += 1
                else:
                    print(f"      ⚠️ Partial compatibility")
                    if missing_fields:
    ...
    def test_bsv_header_compatibility(self):
        ...
        print(f"   📤 Testing Express-style headers")
        self.total_tests += 1
        ...
        for test in error_tests:
            ...
            try:
                ...
                if status_match and format_match and has_error_info:
                    print(f"      ✅ Express error format compatible")
                    self.compatibility_score += 1
                else:
                    print(f"      ⚠️ Partial error compatibility")
    ...
    def test_middleware_utilities_compatibility(self):
        ...
        try:
            ...
            if express_compatible:
                print(f"      ✅ Satoshi formatting Express compatible")
            else:
                print(f"      ⚠️ Satoshi formatting may differ from Express")
            ...
            if has_bsv_info and bsv_fields_present and express_compatible:
                print(f"      ✅ Utility functions fully Express compatible")
                self.compatibility_score += 1
            else:
                print(f"      ⚠️ Partial utility compatibility")
