    ...
    def test_concurrent_request_handling(self, num_requests=50, num_workers=10):
        ...
        def process_request(request_id):
            ...
            payment_data = {
                ...
                'transaction': base64.b64encode(f'concurrent_tx_{request_id}'.encode()).decode('utf-8')
            }
...
def main():
    ...
    results = {
        ...
        'concurrent_handling': tester.test_concurrent_request_handling(num_requests=50, num_workers=10),
