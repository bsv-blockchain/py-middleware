...
class TestIssue5RuntimeCheckable:
    ...
    def test_is_wallet_interface_functionality(self):
        ...
        class CompleteWallet:
            def get_public_key(self, args: Dict[str, Any], originator: Optional[str] = None) -> Dict:
                return {'publicKey': 'test'}
            def create_signature(self, args: Dict[str, Any], originator: Optional[str] = None) -> Dict:
                return {'signature': []}
            def create_action(self, args: Dict[str, Any], originator: Optional[str] = None) -> Dict:
                return {}
            def internalize_action(self, args: Dict[str, Any], originator: Optional[str] = None) -> Dict:
                return {}
