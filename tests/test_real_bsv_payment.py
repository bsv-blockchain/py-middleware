...
class RealBSVPaymentTester:
    ...
    def create_mock_wallet(self):
        ...
        class PaymentTestWallet:
            ...
            def internalize_action(self, args, originator):
                ...
                print(f"📥 internalize_action called:")
    ...
    def test_payment_required_response(self):
        ...
        try:
            ...
            if not bsv_payment_header:
                print(f"✅ No payment header detected")
                ...
                print(f"✅ 402 Response headers prepared:")
                ...
                print(f"✅ 402 Response body prepared:")
    ...
    def test_payment_header_parsing(self):
        ...
        try:
            ...
            print(f"✅ Payment header parsed successfully")
    ...
    def test_payment_internalization(self):
        ...
        try:
            ...
            sender_identity_key = '033f5aed5f6cfbafaf94570c8cde0c0a6e2b5fb0e07ca40ce1d6f6bdfde1e5b9b8'
            ...
            print(f"✅ Action args prepared")
            print(f"   protocol: wallet payment")
            print(f"   outputIndex: 0")
            ...
            print(f"✅ Payment info created for request")
            
            # Response header (Express: lines 120-122)
            response_header = {
                'x-bsv-payment-satoshis-paid': str(payment_info['satoshisPaid'])
            }
            
            print(f"✅ Response header set: x-bsv-payment-satoshis-paid: {payment_info['satoshisPaid']}")
    ...
    def test_free_request_bypass(self):
        ...
        try:
            ...
            if request_price == 0:
                ...
                print(f"✅ Free request - no payment required")
    ...
    def test_complete_payment_flow(self):
        ...
        try:
            ...
            if request_price == 0:
                print(f"✅ No payment required (price = 0)")
                return True
            ...
            if not has_payment_header:
                print(f"⚠️ No payment header → Would return 402 Payment Required")
                return False
            
            print(f"✅ Payment header present")
