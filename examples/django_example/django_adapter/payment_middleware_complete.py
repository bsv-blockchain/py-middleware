...
Express createPaymentMiddleware() の完全移植版
Phase 2.3: Certificate + Payment 統合実装
"""
...
class BSVPaymentMiddleware:
    """
    Django Payment Middleware - Express createPaymentMiddleware() 完全移植
    ...
    def __call__(self, request: HttpRequest) -> HttpResponse:
        ...
        """
        try:
            # Express equivalent: check authentication
            ...
            # Express equivalent: calculate request price
            try:
            ...
            # Express equivalent: if price is 0, continue without payment
            if request_price <= 0:
